...
const CYBORG_LANGUAGES: LanguageWord[] = [
    { text: 'CYBORG', lang: 'ENGLISH (CORE)', font: "'Orbitron', sans-serif", code: 'EN', color: '#26a641' },
    ...
    { text: '01000011 01011001', lang: 'BINARY PROTOCOL', font: "'Share Tech Mono', monospace", code: 'BIN', color: '#26a641' },
                ...
                >
                    ...
                    <div className="relative z-10 flex items-center justify-between text-base sm:text-lg text-[#948e9c] font-qwigley">
                        <div className="flex items-center gap-3">
                            <div className="neo-btn p-2 rounded-xl text-[#26a641]">
                            ...
                            <div className="flex flex-col">
                                ...
                                <span className="text-base text-[#26a641] font-qwigley">
                        ...
                        <div className="flex items-center gap-2 neo-inset px-3 py-1.5 rounded-full border border-[#494551]/30">
                            <span className="w-2 h-2 rounded-full bg-[#FE490D] animate-ping" />
                            <span className="text-base font-bold text-[#26a641] uppercase tracking-widest font-qwigley">
                    ...
                    <div className="relative z-10 my-auto flex flex-col items-center justify-center text-center py-12 px-4">
                        ...
                        <div className="flex items-center gap-1 mb-8 opacity-60">
                            {[40, 75, 30, 90, 60, 100, 45, 80, 35, 95, 50, 85].map((height, i) => (
                                <motion.div
                                    key={i}
                                    className="w-1 bg-[#26a641] rounded-full"
                        ...
                        <div className="min-h-[140px] md:min-h-[180px] flex items-center justify-center w-full relative">
                            <AnimatePresence mode="popLayout">
                                ...
                                >
                                    <h1
                                        className="text-6xl sm:text-8xl md:text-9xl lg:text-10xl tracking-tight leading-none drop-shadow-[0_0_35px_rgba(38,166,65,0.4)] font-qwigley"
                                        style={{
                    ...
                    <div className="relative z-10 space-y-4 max-w-4xl mx-auto w-full">
                        <div className="flex items-center justify-between text-base font-bold text-[#948e9c] px-1 font-qwigley">
                            <div className="flex items-center gap-2">
                                <Activity className="w-3.5 h-3.5 text-[#26a641]" />
                            ...
                            <div className="text-right text-2xl text-[#26a641] font-black tracking-widest font-qwigley">
                                {progress.toFixed(1)}%
                            </div>
                        </div>
                        ...
                        <div className="relative h-3 w-full bg-[#14111d] rounded-full overflow-hidden p-0.5 border border-[#494551]/50 neo-inset">
                            <motion.div
                                className="h-full rounded-full bg-gradient-to-r from-[#9a83db] via-[#26a641] to-[#cfbdff] shadow-[0_0_15px_rgba(38,166,65,0.7)]"
