...
export default function SectionConnector({
  ...
  return (
    <div className="w-full max-w-6xl mx-auto py-8 px-4 flex flex-col items-center justify-center relative overflow-hidden select-none">
      <div className="w-[1px] h-8 bg-gradient-to-b from-transparent via-[#00F2FF]/60 to-[#cfbdff]/80 relative">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-1.5 h-1.5 bg-[#00F2FF] rounded-full" />
      </div>

      <div className="w-full flex items-center justify-center gap-2 md:gap-4 my-1">
        <div className="flex-1 flex items-center">
          <div className="h-[1px] w-full bg-gradient-to-r from-transparent via-[#cfbdff]/20 to-[#00F2FF]/70 relative">
            <motion.div
              animate={{ x: ['0%', '100%'], opacity: [0, 1, 0] }}
              transition={{ duration: 2.5, repeat: Infinity, ease: 'linear' }}
              className="absolute top-1/2 -translate-y-1/2 w-3 h-1 bg-[#00F2FF] rounded-full"
            />
          </div>
          <div className="w-2 h-2 rounded-full border border-[#00F2FF] bg-[#09080e] shrink-0 hidden sm:block" />
        </div>
        ...
        >
          <div className="p-1.5 rounded-lg bg-[#1d182b] border border-[#00F2FF]/40 text-[#00F2FF] relative z-10">
            {variant === 'pulse' ? (
          ...
          <div className="flex flex-col text-left relative z-10">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[8px] font-mono text-[#00F2FF] bg-[#00F2FF]/10 px-1.5 py-0.5 rounded border border-[#00F2FF]/30">
                {nodeId}
              </span>
            </div>
          ...
          <div className="w-2 h-2 rounded-full bg-[#00F2FF] ml-1 relative z-10" />
        </motion.div>

        <div className="flex-1 flex items-center">
          <div className="w-2 h-2 rounded-full border border-[#cfbdff] bg-[#09080e] shrink-0 hidden sm:block" />
          <div className="h-[1px] w-full bg-gradient-to-l from-transparent via-[#cfbdff]/20 to-[#00F2FF]/70 relative">
            <motion.div
      ...
      <div className="w-[1px] h-8 bg-gradient-to-b from-[#cfbdff]/80 via-[#00F2FF]/60 to-transparent relative">
