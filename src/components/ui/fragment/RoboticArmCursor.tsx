...
export default function RoboticArmCursor() {
  ...
  const mainColor = isHovered ? '#9a83db' : '#cfbdff';
    ...
    <div className="fixed inset-0 pointer-events-none z-[9999] overflow-hidden">
      <svg className="w-full h-full">
        ...
        <path
          ...
          fill="none"
          stroke={isHovered ? '#9a83db' : '#9a83db'}
          strokeWidth="1.5"
          strokeDasharray="3 2"
          opacity="0.9"
        />
        ...
        <g transform={`translate(${wx}, ${wy})`}>
          ...
          <g transform="translate(18, 18)">
            <rect
              ...
              stroke={isHovered ? 'rgba(154, 131, 219, 0.5)' : 'rgba(207, 189, 255, 0.3)'}
              strokeWidth="1"
            />
            <text
              x="5"
              y="1"
              fill={isHovered ? '#9a83db' : '#cfbdff'}
              fontSize="8"
